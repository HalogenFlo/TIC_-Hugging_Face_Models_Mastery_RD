...
class TaxLawAgent(BaseAgent):
    ...
    def __init__(self, provider: str = DEFAULT_PROVIDER):
        goal_context = (
            ...
            "1. Về Đối tượng: Nếu người dùng ĐÃ NÊU CỤ THỂ ĐỐI TƯỢNG (ví dụ: 'Tôi là doanh nghiệp tư nhân...'), "
            ...
            "(điều luật đó quy định những gì, điều kiện ra sao, mức áp dụng cụ thể thế nào...) dựa trên dữ liệu CSDL được cung cấp "
        ...
        task_boundary = (
            ...
            "(ví dụ: [219/2013/TT-BTC - Điều 4 - Khoản 1 - Điểm a]). "
